...
def _main_(args):   
    ...
    now=datetime.now()
    plt.savefig('/home/basile/Documents/projet_bees_detection_basile/bees_detection/src/yolo/data/outputs/lr_finder_on_{}_.png'.format(now.strftime("%d_%m_%Y_%H_%M")))
