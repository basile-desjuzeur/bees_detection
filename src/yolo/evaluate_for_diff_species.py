...
def _main_eval_diff_(args): 
    ...
    os.makedirs('/home/basile/Documents/projet_bees_detection_basile/bees_detection/src/datafiles/yolo/temp_'+start_time.strftime("%Y%m%d-%H%M%S"))
    ...
    for label in labels: 
        ...
        path_to_csv='/home/basile/Documents/projet_bees_detection_basile/bees_detection/src/datafiles/yolo/temp_'+start_time.strftime("%Y%m%d-%H%M%S")+'/temp_csv_{}.csv'.format(label)
    ...
    path_to_csv='/home/basile/Documents/projet_bees_detection_basile/bees_detection/src/datafiles/yolo/temp_'+start_time.strftime("%Y%m%d-%H%M%S")+'/temp_csv_all_species.csv'
    ...
    shutil.rmtree('/home/basile/Documents/projet_bees_detection_basile/bees_detection/src/datafiles/yolo/temp_'+start_time.strftime("%Y%m%d-%H%M%S"))
