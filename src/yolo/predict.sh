...
$parentFolder = '/workspaces/projet_bees_detection_basile/data_bees_detection/whole_dataset/iNaturalist'
$predictScript = '/workspaces/projet_bees_detection_basile/bees_detection/src/yolo/predict.py'
