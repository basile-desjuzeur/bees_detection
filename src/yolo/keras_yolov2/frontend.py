...
#from tensorflow.keras.optimizers.legacy import Adam                     #ok for train not for evaluate
...
class YOLO(object):
    ...
    def train(self, train_imgs,  # the list of images to train the model
              ...
              optimizer_config,
              mosaic='none',
              saved_pickles_path='/workspaces/projet_bees_detection_basile/bees_detection/src/datafiles/yolo/pickles',
              saved_weights_name='/workspaces/projet_bees_detection_basile/bees_detection/src/datafiles/yolo/saved_weights/best_model_bestLoss.h5',
              workers=3,
              max_queue_size=8,
              early_stop=True,
              tb_logdir="./",
        ...
        # ckp_best_loss = ModelCheckpoint("/workspaces/projet_bees_detection_basile/bees_detection/src/datafiles/yolo/saved_weights/benchmark_weights/model",
        #                                 monitor='val_loss',
        #                                 verbose=1,
        #                                 save_best_only=True,
        #                                 mode='min',
        #                                 period=1)
        nan_callback = AntiNaN() #permet de revenir à la dernière sauvegarde si on a un nan
