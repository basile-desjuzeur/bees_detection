...
pickle_path_bad = "/home/basile/Documents/projet_bees_detection_basile/bees_detection/src/data/pickles/histories/MobileNetV2-alpha=1.0_2023-03-23-17:21:53_0/temp_csv_all_species/bad_boxes_MobileNetV2-alpha=1.0_temp_csv_all_species.p"

# Open pickle
with open(pickle_path_bad, 'rb') as fp:
