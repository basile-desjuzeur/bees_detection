...
parser.add_argument(
    ...
    default='/home/basile/Documents/projet_bees_detection_basile/bees_detection/src/segment-anything/checkpoints/sam_vit_b_01ec64.pth'
)
...
def write_masks_to_folder(masks: List[Dict[str, Any]], path: str) -> None:
    ...
    for i, mask_data in enumerate(masks):
        ...
        mask_metadata = [
            ...
            *[str(x) for x in mask_data["xoint_coords"][0]],
...
def main(args: argparse.Namespace) -> None:
    ...
    generator = SamAutomaticMaskGenerator(sam, output_mode=output_mode,points_per_batch=2, **amg_kwargs)
