...
###### EXAMPLE INPUTS ######
###### see description of _main_ for more details ######
...
argparser.add_argument(
    ...
    default=path_whole_dataset_csv)

argparser.add_argument(
    '-o',
    '--path_output_csv',
    help='path to output the csv files in a folder',
    default=path_output_csv)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_taxref', default=path_taxref)
    parser.add_argument('--path_whole_dataset_csv', default=path_whole_dataset_csv)
    parser.add_argument('--path_output_csv', default=path_output_csv)
