...
argparser.add_argument(
  '-w',
  '--weights',
  #default='/home/basile/Documents/projet_bees_detection_basile/bees_detection/src/data/saved_weights/benchmark_weights/model_classic_bestLoss.h5',
  type=str,
...
argparser.add_argument(
  '-l',
  '--lite',
  default='/home/basile/Documents/projet_bees_detection_basile/bees_detection/src/tf_lite/tf_lite.csv',
  type=str,
...
def _main_(args):
    ...
    try:
      os.mkdir("/home/basile/Documents/projet_bees_detection_basile/bees_detection/src/tf_lite")
    except:
      pass
